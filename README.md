# 01 Car Parts Detection

Use the app here: [https://car-part-detect.streamlit.app/](https://car-part-detect.streamlit.app/)

Navigate:
- `car_app.py`: main app & GUI
- `car_part_model.py`: model architecture
